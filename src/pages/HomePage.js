...
export default function HomePage() {
  return (
    <div className='w-[550px] h-[600px] rounded-md bg-gray-100 dark:bg-gray-700 dark:text-gray-50 flex items-center justify-center flex-col'>
      ...
      <div className='flex flex-col justify-center items-center gap-8 mb-10'>
        ...
        <h2 className='font-bold text-4xl tracking-widest'>NOTES App</h2>
      </div>
      <div className='flex items-center justify-between gap-4'>
        ...
        <Link to="signup">
        <button className='px-6 py-2 rounded-full bg-gradient-to-r from-zinc-100 to-indigo-200 hover:from-indigo-200 hover:to-zinc-100 border-2 border-purple-600 font-semibold dark:text-gray-900'>
            Sign Up
        </button>
        </Link>
      </div>
